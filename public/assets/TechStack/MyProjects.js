  ...
  return (
    <section id="projects" className="pt-10 pb-24">
      ...
      <div className="md:flex md:justify-between mt-16 gap-16">
        ...
        {/* IXORA */}
        <motion.div
          className="md:w-1/3 mt-10 relative z-0 ml-20 p-16 before:absolute before:bottom-10 before:right-10
          before:w-full before:h-full before:border-2 before:border-blue before:z-[-1]"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
        ...
        >
          ...
          <div className="w-full h-full m-5 overflow-hidden mx-auto">
